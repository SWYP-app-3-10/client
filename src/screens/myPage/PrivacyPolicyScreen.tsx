      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.subSection}>
            ...
            <Text style={styles.text}>
              ...
              외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의
          ...
          <View style={styles.subSection}>
            ...
            <Text style={styles.text}>
              ...
              만 14세 미만 아동의 개인정보를 수집하지 않습니다. 만약 만 14세 미만
        ...
        <View style={styles.section}>
          ...
          <View style={styles.subSection}>
            ...
            <View style={styles.bulletList}>
              ...
              {renderItem('2.', '서비스 이용 및 초기 설정: 관심 분야(카테고리), 설정 난이도')}
              {renderItem(
                '3.',
          ...
          <View style={styles.subSection}>
            ...
            <View style={styles.bulletList}>
              ...
              {renderItem('3.', '서비스 이용 과정에서 자동 생성 정보 수집 툴(SDK 등)을 통한 수집')}
            </View>
          </View>

          <View style={styles.subSection}>
            <Text style={styles.subTitle}>다. 개인정보 자동 수집 장치의 설치·운영 및 거부</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.subSection}>
            ...
            <Text style={styles.text}>
              팀은 원활한 서비스 이행을 위해 다음과 같이 개인정보 처리 업무를 외부 전문 업체에 위탁하여 운영하고 있습니다.
            </Text>

            {/* 테이블 */}
            <View style={styles.table}>
              <View style={styles.tableRow}>
                <Text style={[styles.tableHeader, { flex: 1 }, styles.borderRight]}>
                  수탁 업체
                </Text>
                <Text style={[styles.tableHeader, { flex: 1 }, styles.borderRight]}>
                  위탁 업무 내용
          ...
          <View style={styles.subSection}>
            ...
            <Text style={styles.text}>팀은 광고 서비스 제공을 위해 아래와 같이 개인정보를 국외(미국)로 이전합니다.</Text>
            <View style={styles.bulletList}>
              {renderItem('1.', '이전 항목: 광고 식별자(ADID/IDFA), 단말기 정보(모델명, OS), 서비스 이용 기록, 접속 IP')}
              {renderItem('2.', '이전 목적: 리워드 광고 송출 및 보상(포인트) 지급 확인, 광고 부정 이용 방지')}
              {renderItem('3.', '이전 일시 및 방법: 광고 호출 및 시청 시점에 SDK를 통해 암호화 전송')}
              {renderItem('4.', '보유 및 이용 기간: 수집 목적 달성 시까지 (Google의 개인정보 처리방침에 따름)')}
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.subSection}>
            ...
            <View style={styles.bulletList}>
              {renderItem('1.', '이용자의 개인정보는 수집 및 이용 목적이 달성되면 지체 없이 즉시 파기하는 것을 원칙으로 합니다.')}
              {renderItem('2.', '이용자가 회원 탈퇴를 요청하거나 개인정보 수집 동의를 철회하는 경우, 해당 이용자의 데이터는 복구할 수 없는 방법으로 즉시 삭제됩니다.')}
            </View>
          </View>
          ...
          <View style={styles.subSection}>
            ...
            <View style={styles.bulletList}>
              {renderItem('1.', '파기 절차: 이용자가 입력한 정보 및 생성된 모든 데이터는 목적 달성 시(회원 탈퇴 등) 별도의 보관 기간 없이 데이터베이스(DB)에서 해당 이용자의 모든 내역을 즉시 삭제합니다.')}
              {renderItem('2.', '파기 방법: 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 영구 삭제합니다.')}
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            {renderItem('1.', '권리 행사 방법: 앱 내 [마이페이지 > 설정 > 로그인 정보] 메뉴를 통해 직접 조회 및 수정이 가능하며, [회원 탈퇴] 기능을 통해 동의 철회가 가능합니다.')}
            {renderItem('2.', '이용자가 개인정보의 오류에 대한 정정을 요청한 경우, 정정을 완료하기 전까지 당해 개인정보를 이용하거나 제공하지 않습니다.')}
          </View>
        </View>

        {/* 6. 개인정보 보호 책임자 및 권익침해 구제방법 */}
        <View style={styles.section}>
          <Text style={styles.title}>6. 개인정보 보호 책임자 및 권익침해 구제방법</Text>

          <View style={styles.subSection}>
            <Text style={styles.subTitle}>가. 개인정보 보호 책임자</Text>
            <Text style={styles.text}>
              팀은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만 처리 및 피해 구제 등을 위하여 아래와 같이 개인정보 보호 책임자를 지정하고 있습니다.
            </Text>
          ...
          <View style={styles.subSection}>
            <Text style={styles.subTitle}>나. 정보주체의 권익침해에 대한 구제방법</Text>
            <Text style={styles.text}>
              기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.
            </Text>
            <View style={styles.bulletList}>
              {renderItem('•', '개인정보분쟁조정위원회 (www.kopico.go.kr / 1833-6972)')}
              {renderItem('•', '개인정보침해신고센터 (privacy.kisa.or.kr / 118)')}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            이 개인정보 처리방침은 시행일로부터 적용되며, 관련 법률 및 지침의 변경과 내부 운영 방침의 변경에 따라 변경될 수 있습니다.
            현 개인정보처리방침의 내용 추가, 삭제 및 수정이 있을 시에는 시행일 최소 7일 전부터 서비스 알림을 통해 고지할 것입니다.
          </Text>
