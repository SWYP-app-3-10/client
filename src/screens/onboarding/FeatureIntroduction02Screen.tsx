...
const FeatureIntroduction02Screen = () => {
  const navigation = useNavigation<NavigationProp>();

  const handleNext = () => {
    navigation.navigate(RouteNames.FEATURE_INTRO_03);
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.imagePlaceholder}>
          <Text style={styles.placeholderText}>캐시 기능 이미지</Text>
        </View>

        {/* 텍스트 placeholder */}
        <View style={styles.textPlaceholder}>
          <Text style={styles.placeholderText}>캐시 기능 설명</Text>
        </View>
...
export default FeatureIntroduction02Screen;
